...
def further_improved_apriori(filename, support, confidence, maxr):
...
def freq_itemsets(L1, support):
    ...
    while True:
        ...
        # Prune itemsets in Ck that were not in Lk-1 if Lk > 1, otherwise I don't prune
        Ck = []
        if k > 2:
        ...
        else: # I don't want pruning for C2 so Ck = Ckc for C2
            Ck = Ckc
